    ...
    $.ajax({url: queryURL, method: 'GET'})
        .done(function(response) {
            ...
            for(var i=0;i<response.data.length; i++) {
                var searchDiv = $('<div class="search-item d-flex justify-content-center m-4">');
                var rating = response.data[i].rating;
                var p = $('<p style="color:white; position:relative; right:100px;" class="shadow">').text('Rating: ' + rating);
